#pragma checksum "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d86f9c7d8b96ca50d3f0cf75d33d3bdf47a3053d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d86f9c7d8b96ca50d3f0cf75d33d3bdf47a3053d", @"/Views/Home/Index.cshtml")]
...
");
    ...
    <!-- Modal -->
    <div id=""order-modal"" class=""modal fade"" tabindex=""-1"" role=""dialog"" a");
            WriteLiteral(@"ria-labelledby=""orderModalLabel"" aria-hidden=""true"">
  ...
  ");
            WriteLiteral(@"                          <!-- Opciones de pilotos -->
                        </select>
        ...
        <script type=""text/javascript"">
            ...
            $(document).ready(function () {
                 $.ajax({
                    url: '");
#nullable restore
#line 440 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            if (!nofolio) {
                ...
                $.ajax({
                    url: '");
#nullable restore
#line 461 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 518 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            $.ajax({
                url: '");
#nullable restore
#line 572 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            function getPilotosAct() {
                 $.ajax({
                    url: '");
#nullable restore
#line 612 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 654 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 694 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            /*function updateList(listaPedidos) {
                ...
                categories.forEach(category => {
                    ...
                    const pedidosFiltrados = listaPedidos.filter(pedido => categoryMap[pedido.estado_actual] === category);
   ...
   ");
            WriteLiteral(@"                     li.addEventListener('click', function () {
                            showModal(pedido);
                        });
                        ul.appendChild(li);
                    });
            ...
            function updateList(listaPedidos) {
                ...
                // Obtener los valores de los ped");
            WriteLiteral(@"idos con el último estado
                ...
                categories.forEach(category => {
                    ...
                    pedidosFiltrados.forEach(pedido => {
                        const li = document.createElement('li');
         ");
            WriteLiteral(@"               li.textContent = `Folio: ${pedido.folio} - Cliente: ${pedido.cliente} - Fecha: ${pedido.fecha_estado}`;
      ...
      ");
            WriteLiteral(@"          const statusChangeOptions = document.getElementById('status-change-options');
      ...
      ");
          ...
          ");
            ...
            ");
            WriteLiteral(@"// Función para obtener el equivalente en español dado un estado en inglés
            ...
            function changeOrderState(pedido, newState, piloto, paqueteria, obvs) {
                ...
                console.log(parametros);
                //d");
            WriteLiteral("ocument.getElementById(\'contenedor-loader\').style.display = \'flex\';\r\n                if (pedido.estado_actual && pedido.estado_actual !== newState) {\r\n                    $.ajax({\r\n                    url: \'");
#nullable restore
#line 956 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
