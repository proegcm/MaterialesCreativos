#pragma checksum "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "57fa75b35587daca99970b9bf999dba0502283c1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"57fa75b35587daca99970b9bf999dba0502283c1", @"/Views/Home/Index.cshtml")]
    ...
    /* Alinea el conte");
            WriteLiteral(@"nido dentro de las listas */
   ...
   ");
            WriteLiteral(@"                         <div class=""col-12"">
                            ...
                            <div class=""col-12"">
                                ...
                                <button class=""btn btn-block w-100 mt-2"" style=""background-color: #e86217; color: #ffffff; "" id=""btn");
            WriteLiteral(@"PasarProduccion"" onclick=""ingresaTicket()"">
                            ...
                            <div class=""col-12"">
                                <div class=""form-group order-category"">
                                    ...
                                    <ul id=""courier-orders"">
                                        <!-- Li");
            WriteLiteral(@"stado de pedidos enviados por mensajería -->
                                    </ul>
                                </div>
                            </div>
                            <div class=""col-12"">
            ...
            WriteLiteral(@"/div>
                            ...
                            <div class=""col-12"">
                                <div class=""form-gro");
            WriteLiteral(@"up order-category"">
                                    <h3>Reprogramado</h3>
                                    <ul id=""rescheduled-orders"">
    ...
    <!-- Modal -->
    <div id=""order-modal"" class=""modal fade"" tabi");
            WriteLiteral(@"ndex=""-1"" aria-labelledby=""orderModalLabel"" aria-hidden=""true"">
            ...
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    ...
                    <div id=""pilot-selection"" style=""display: none;"">
                        ...
                        <select id=""pilot-selec");
            WriteLiteral(@"t"" class=""form-control mb-2"">
                            <!-- Opciones de pilotos -->
                        </select>
             ...
             ");
            WriteLiteral(@"       <div id=""status-change-options"" class=""d-flex flex-row gap-2"">
        ...
        <script type=""text/javascript"">
            ...
            $(document).ready(function () {
                 $.ajax({
                    url: '");
#nullable restore
#line 350 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            if (!nofolio) {
                ...
                $.ajax({
                    url: '");
#nullable restore
#line 371 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 428 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            $.ajax({
                url: '");
#nullable restore
#line 484 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            function getPilotosAct() {
                 $.ajax({
                    url: '");
#nullable restore
#line 524 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 566 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable restore
#line 606 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            function updateList(listaPedidos) {
                ...
                console.log(""pedid");
            WriteLiteral(@"osConUltimoEstado: "");
                ...
                categories.forEach(category => {
                    ...
                    pedidosFiltrados.forEach(pedido => {
                        ...
                        l");
            WriteLiteral(@"i.addEventListener('click', function () {
                            showModal(pedido);
                        });
                        ul.appendChild(li);
                    });
            ...
            function showModal(pedido) {
                ...
                const pilotSelection = document.getEleme");
            WriteLiteral(@"ntById('pilot-selection');
                        ...
                        if (nextState.state === 'courier') { // Enviar por Mensajería
                            ...
                            assignPilotBtn.addEventListener('click', function () {
                                ...
                                if (selectedPilot) {
                                    ...
                                    changeOrderState(pedido, next");
            WriteLiteral(@"State.state, piloto, paqueteria, obvs);
                                } else {
                            ...
                            assignParcelBtn.addEventListener('click', function () {
                                ...
                                if (selectedParcel) {
                                    ...
                                    console.log('Paquetería asi");
            WriteLiteral(@"gnada: ' + selectedParcel);
                ...
                modal");
            WriteLiteral(@"Instance = new bootstrap.Modal(modalElement);
                modalInstance.show();
            }
            ...
            function getNextStates(currentState) {
                ...
                const stateTransitions = {
                    ...
                    parcel: [
   ");
            WriteLiteral(@"                     { state: 'returned', label: 'Devuelto' },
                        { state: 'delivered', label: 'Entregado' }
                    ],
                    delivered: [],
            ...
            // Función para obtener el equivalent");
            WriteLiteral(@"e en español dado un estado en inglés
            ...
            WriteLiteral("-loader\').style.display = \'flex\';\r\n                if (pedido.estado_actual && pedido.estado_actual !== newState) {\r\n                    $.ajax({\r\n                    url: \'");
#nullable restore
#line 844 "C:\Users\gabi_\OneDrive\Documentos\PORTAL\PortalServiciosMC\ServiciosMC\Views\Home\Index.cshtml"
